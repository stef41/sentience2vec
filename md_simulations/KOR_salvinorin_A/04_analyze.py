#!/usr/bin/env python3
"""
Trajectory Analysis for KOR_salvinorin_A
...
print("="*60)
print("TRAJECTORY ANALYSIS: KOR_salvinorin_A")
print("="*60)
...
try:
    u = mda.Universe(
        "/data/users/zacharie/whc/consciousness_study/md_simulations/KOR_salvinorin_A/minimized.pdb",  # Topology
        "/data/users/zacharie/whc/consciousness_study/md_simulations/KOR_salvinorin_A/trajectory.dcd"   # Trajectory
    )
    ...
    u = mda.Universe("/data/users/zacharie/whc/consciousness_study/md_simulations/KOR_salvinorin_A/final.pdb")

# Define selections
protein = u.select_atoms("protein")
backbone = u.select_atoms("protein and backbone")
binding_site = u.select_atoms("protein and resid 138 139 141 192 219 223 280 283 284 312")
...
print(f"  Binding residues: [138, 139, 141, 192, 219, 223, 280, 283, 284, 312]")
...
if hasattr(u.trajectory, '__len__') and len(u.trajectory) > 1:
    ...
    bs_rmsd = rms.RMSD(u, u, select='resid 138 139 141 192 219 223 280 283 284 312 and backbone', ref_frame=0)
    bs_rmsd.run()
    ...
    try:
        import pandas as pd
        log_data = pd.read_csv("/data/users/zacharie/whc/consciousness_study/md_simulations/KOR_salvinorin_A/production.log", sep=',', skiprows=1, 
    ...
    plt.tight_layout()
    plt.savefig("/data/users/zacharie/whc/consciousness_study/md_simulations/KOR_salvinorin_A/analysis_results.png", dpi=150)
    print(f"  Saved: /data/users/zacharie/whc/consciousness_study/md_simulations/KOR_salvinorin_A/analysis_results.png")
    
    # ========================================
    # Save Results
    # ========================================
    results = {
        "system": "KOR_salvinorin_A",
        ...
        "binding_residues": [138, 139, 141, 192, 219, 223, 280, 283, 284, 312]
    }
...
with open("/data/users/zacharie/whc/consciousness_study/md_simulations/KOR_salvinorin_A/analysis_results.json", 'w') as f:
    json.dump(results, f, indent=2)

print(f"\n✓ Analysis complete!")
print(f"  Results: /data/users/zacharie/whc/consciousness_study/md_simulations/KOR_salvinorin_A/analysis_results.json")
