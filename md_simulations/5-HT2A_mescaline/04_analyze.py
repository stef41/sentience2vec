#!/usr/bin/env python3
"""
Trajectory Analysis for 5-HT2A_mescaline
...
print("="*60)
print("TRAJECTORY ANALYSIS: 5-HT2A_mescaline")
print("="*60)
...
try:
    u = mda.Universe(
        "/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_mescaline/minimized.pdb",  # Topology
        "/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_mescaline/trajectory.dcd"   # Trajectory
    )
    ...
    u = mda.Universe("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_mescaline/final.pdb")

# Define selections
protein = u.select_atoms("protein")
backbone = u.select_atoms("protein and backbone")
binding_site = u.select_atoms("protein and resid 151 155 159 207 229 230 234 313 336 340 366")
...
print(f"  Binding residues: [151, 155, 159, 207, 229, 230, 234, 313, 336, 340, 366]")
...
if hasattr(u.trajectory, '__len__') and len(u.trajectory) > 1:
    ...
    bs_rmsd = rms.RMSD(u, u, select='resid 151 155 159 207 229 230 234 313 336 340 366 and backbone', ref_frame=0)
    bs_rmsd.run()
    ...
    try:
        import pandas as pd
        log_data = pd.read_csv("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_mescaline/production.log", sep=',', skiprows=1, 
    ...
    plt.tight_layout()
    plt.savefig("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_mescaline/analysis_results.png", dpi=150)
    print(f"  Saved: /data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_mescaline/analysis_results.png")
    
    # ========================================
    # Save Results
    # ========================================
    results = {
        "system": "5-HT2A_mescaline",
        ...
        "binding_residues": [151, 155, 159, 207, 229, 230, 234, 313, 336, 340, 366]
    }
...
with open("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_mescaline/analysis_results.json", 'w') as f:
    json.dump(results, f, indent=2)

print(f"\n✓ Analysis complete!")
print(f"  Results: /data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_mescaline/analysis_results.json")
