#!/usr/bin/env python3
"""
Energy Minimization for D2_LSD
"""
import openmm as mm
...
print("="*60)
print("ENERGY MINIMIZATION: D2_LSD")
print("="*60)

# Load receptor
print("\nLoading receptor...")
receptor = app.PDBFile("/data/users/zacharie/whc/consciousness_study/md_simulations/structures/6CM4.pdb")
...
output_pdb = "/data/users/zacharie/whc/consciousness_study/md_simulations/D2_LSD/minimized.pdb"
