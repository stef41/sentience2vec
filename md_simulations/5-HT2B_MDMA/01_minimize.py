#!/usr/bin/env python3
"""
Energy Minimization for 5-HT2B_MDMA
"""
import openmm as mm
...
print("="*60)
print("ENERGY MINIMIZATION: 5-HT2B_MDMA")
print("="*60)

# Load receptor
print("\nLoading receptor...")
receptor = app.PDBFile("/data/users/zacharie/whc/consciousness_study/md_simulations/structures/5TVN.pdb")
...
output_pdb = "/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2B_MDMA/minimized.pdb"
