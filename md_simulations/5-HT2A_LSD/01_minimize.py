#!/usr/bin/env python3
"""
Energy Minimization for 5-HT2A_LSD
"""
import openmm as mm
...
print("="*60)
print("ENERGY MINIMIZATION: 5-HT2A_LSD")
print("="*60)

# Use pre-fixed PDB structure
receptor_pdb = "/data/users/zacharie/whc/consciousness_study/md_simulations/structures/6WHA_fixed.pdb"
...
output_pdb = "/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/minimized.pdb"
