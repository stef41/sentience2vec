#!/usr/bin/env python3
"""
Trajectory Analysis for 5-HT2A_LSD
...
print("="*60)
print("TRAJECTORY ANALYSIS: 5-HT2A_LSD")
print("="*60)
...
try:
    u = mda.Universe(
        "/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/minimized.pdb",  # Topology
        "/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/trajectory.dcd"   # Trajectory
    )
    ...
    u = mda.Universe("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/final.pdb")
...
if hasattr(u.trajectory, '__len__') and len(u.trajectory) > 1:
    ...
    try:
        import pandas as pd
        log_data = pd.read_csv("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/production.log", sep=',', skiprows=1, 
    ...
    plt.tight_layout()
    plt.savefig("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/analysis_results.png", dpi=150)
    print(f"  Saved: /data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/analysis_results.png")
...
with open("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/analysis_results.json", 'w') as f:
    json.dump(results, f, indent=2)

print(f"\n✓ Analysis complete!")
print(f"  Results: /data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_LSD/analysis_results.json")
