#!/usr/bin/env python3
"""
Production MD Simulation for 5-HT2A_MDMA
Duration: 10.0 ns
"""
import openmm as mm
...
print("="*60)
print("PRODUCTION MD: 5-HT2A_MDMA")
print("Duration: 10.0 ns")
print("="*60)

# Load equilibrated structure
print("\nLoading equilibrated structure...")
pdb = app.PDBFile("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_MDMA/equilibrated.pdb")
...
checkpoint_file = "/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_MDMA/equilibrated.chk"
try:
...
simulation.reporters.append(
    app.DCDReporter('/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_MDMA/trajectory.dcd', 5000)
)
simulation.reporters.append(
    app.StateDataReporter(
        '/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_MDMA/production.log',
        5000,
        step=True,
        time=True,
...
simulation.reporters.append(
    app.CheckpointReporter('/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_MDMA/production.chk', 50000)
)
...
# Save final state
simulation.saveState("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_MDMA/final_state.xml")
state = simulation.context.getState(getPositions=True)
with open("/data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_MDMA/final.pdb", 'w') as f:
    app.PDBFile.writeFile(simulation.topology, state.getPositions(), f)

total_time = time.time() - start_time
print(f"\n✓ Production complete!")
print(f"  Total wall time: {total_time/3600:.2f} hours")
print(f"  Output: /data/users/zacharie/whc/consciousness_study/md_simulations/5-HT2A_MDMA/trajectory.dcd")
