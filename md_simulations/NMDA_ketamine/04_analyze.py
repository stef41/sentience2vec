#!/usr/bin/env python3
"""
Trajectory Analysis for NMDA_ketamine
...
print("="*60)
print("TRAJECTORY ANALYSIS: NMDA_ketamine")
print("="*60)
...
try:
    u = mda.Universe(
        "/data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/minimized.pdb",  # Topology
        "/data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/trajectory.dcd"   # Trajectory
    )
    ...
    u = mda.Universe("/data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/final.pdb")

# Define selections
protein = u.select_atoms("protein")
backbone = u.select_atoms("protein and backbone")
binding_site = u.select_atoms("protein and resid 518 531 532 786 788 790 810 811 813")
...
print(f"  Binding residues: [518, 531, 532, 786, 788, 790, 810, 811, 813]")
...
if hasattr(u.trajectory, '__len__') and len(u.trajectory) > 1:
    ...
    bs_rmsd = rms.RMSD(u, u, select='resid 518 531 532 786 788 790 810 811 813 and backbone', ref_frame=0)
    bs_rmsd.run()
    ...
    try:
        import pandas as pd
        log_data = pd.read_csv("/data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/production.log", sep=',', skiprows=1, 
    ...
    plt.tight_layout()
    plt.savefig("/data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/analysis_results.png", dpi=150)
    print(f"  Saved: /data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/analysis_results.png")
    
    # ========================================
    # Save Results
    # ========================================
    results = {
        "system": "NMDA_ketamine",
        ...
        "binding_residues": [518, 531, 532, 786, 788, 790, 810, 811, 813]
    }
...
with open("/data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/analysis_results.json", 'w') as f:
    json.dump(results, f, indent=2)

print(f"\n✓ Analysis complete!")
print(f"  Results: /data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/analysis_results.json")
