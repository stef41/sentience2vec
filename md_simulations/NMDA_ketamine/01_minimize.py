#!/usr/bin/env python3
"""
Energy Minimization for NMDA_ketamine
"""
import openmm as mm
...
print("="*60)
print("ENERGY MINIMIZATION: NMDA_ketamine")
print("="*60)

# Load receptor
print("\nLoading receptor...")
receptor = app.PDBFile("/data/users/zacharie/whc/consciousness_study/md_simulations/structures/4PE5.pdb")
...
output_pdb = "/data/users/zacharie/whc/consciousness_study/md_simulations/NMDA_ketamine/minimized.pdb"
