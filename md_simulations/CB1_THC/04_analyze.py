#!/usr/bin/env python3
"""
Trajectory Analysis for CB1_THC
...
print("="*60)
print("TRAJECTORY ANALYSIS: CB1_THC")
print("="*60)
...
try:
    u = mda.Universe(
        "/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/minimized.pdb",  # Topology
        "/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/trajectory.dcd"   # Trajectory
    )
    ...
    u = mda.Universe("/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/final.pdb")

# Define selections
protein = u.select_atoms("protein")
backbone = u.select_atoms("protein and backbone")
binding_site = u.select_atoms("protein and resid 178 182 192 193 196 274 277 278 353 356 360")
...
print(f"  Binding residues: [178, 182, 192, 193, 196, 274, 277, 278, 353, 356, 360]")
...
if hasattr(u.trajectory, '__len__') and len(u.trajectory) > 1:
    ...
    bs_rmsd = rms.RMSD(u, u, select='resid 178 182 192 193 196 274 277 278 353 356 360 and backbone', ref_frame=0)
    bs_rmsd.run()
    ...
    try:
        import pandas as pd
        log_data = pd.read_csv("/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/production.log", sep=',', skiprows=1, 
    ...
    plt.tight_layout()
    plt.savefig("/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/analysis_results.png", dpi=150)
    print(f"  Saved: /data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/analysis_results.png")
    ...
    results = {
        ...
        "binding_residues": [178, 182, 192, 193, 196, 274, 277, 278, 353, 356, 360]
    }
...
with open("/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/analysis_results.json", 'w') as f:
    json.dump(results, f, indent=2)

print(f"\n✓ Analysis complete!")
print(f"  Results: /data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/analysis_results.json")
