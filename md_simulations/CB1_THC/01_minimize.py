#!/usr/bin/env python3
"""
Energy Minimization for CB1_THC
"""
import openmm as mm
...
print("="*60)
print("ENERGY MINIMIZATION: CB1_THC")
print("="*60)

# Load receptor
print("\nLoading receptor...")
receptor = app.PDBFile("/data/users/zacharie/whc/consciousness_study/md_simulations/structures/5TGZ.pdb")
...
output_pdb = "/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/minimized.pdb"
