#!/usr/bin/env python3
"""
Production MD Simulation for CB1_THC
Duration: 10.0 ns
"""
import openmm as mm
...
print("="*60)
print("PRODUCTION MD: CB1_THC")
print("Duration: 10.0 ns")
print("="*60)

# Load equilibrated structure
print("\nLoading equilibrated structure...")
pdb = app.PDBFile("/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/equilibrated.pdb")
...
checkpoint_file = "/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/equilibrated.chk"
try:
...
simulation.reporters.append(
    app.DCDReporter('/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/trajectory.dcd', 5000)
)
simulation.reporters.append(
    app.StateDataReporter(
        '/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/production.log',
        5000,
        step=True,
        time=True,
...
simulation.reporters.append(
    app.CheckpointReporter('/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/production.chk', 50000)
)
...
# Save final state
simulation.saveState("/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/final_state.xml")
state = simulation.context.getState(getPositions=True)
with open("/data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/final.pdb", 'w') as f:
    app.PDBFile.writeFile(simulation.topology, state.getPositions(), f)

total_time = time.time() - start_time
print(f"\n✓ Production complete!")
print(f"  Total wall time: {total_time/3600:.2f} hours")
print(f"  Output: /data/users/zacharie/whc/consciousness_study/md_simulations/CB1_THC/trajectory.dcd")
